import os
import sys
from SCRIPT.enrichment.validation import time_estimate, check_para
from SCRIPT.utils.utils import read_config, read_SingleCellExperiment_rds, print_log, excute_info
...
def enrich(processed_adata, cell_feature_adata, project='',
           ...
           integration=True, result_store_path='SCRIPT_computed.h5ad',
...
def run( args ):
    processed_adata = args.processed_experiment
