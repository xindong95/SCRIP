...
SCRIPT enrich -e ../test/sc_experiment.h5ad -i ../test/peak_count.h5 -s hs -p ../test/project --cell_number auto --peak_confidence auto --bg_iter 200 --reference chip -t 8 -y
